...
const childMemProgramSchema = new mongoose.Schema({
  ...
  readingLevel: { type: String, enum: ['no_reading', 'phonetic', 'fluent'], default: 'no_reading' },
  ...
  preferredTimes: {
    type: [String],
    enum: ['morning_9_11','noon_12_3','afternoon_4_7','evening_8_10'],
    default: [],
  },

  // Teacher/session preferences
  teacherGender: { type: String, enum: ['female','male','no_preference'], default: 'no_preference' },
  notesForTeacher: { type: String },

  // Plan
  planName: { type: String, required: true },
  memorizationDirection: { type: String, enum: ['fatihah_to_nas','nas_to_fatihah'], default: 'fatihah_to_nas' },
  ...
  // Admin / assignment
  assignedTeacher: { type: mongoose.Schema.ObjectId, ref: 'User' }, // assigned later
  allowTrial: { type: Boolean, default: true },
